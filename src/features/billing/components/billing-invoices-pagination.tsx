...
interface BillingInvoicesPaginationProps {
  pagination: PaginatedResponse<BillingInvoice>["pagination"];
}
...
export function BillingInvoicesPagination({ pagination }: BillingInvoicesPaginationProps) {
